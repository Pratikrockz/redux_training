...
})({"bWtwo":[function(require,module,exports,__globalThis) {
...
const reducer = (0, _redux.combineReducers)({
    ...
    cartItem: (0, _cartReducerDefault.default),
...
store.dispatch((0, _cartReducer.IncreasecartItem)(1, 5));
store.dispatch((0, _cartReducer.IncreasecartItem)(2));
store.dispatch((0, _cartReducer.IncreasecartItem)(5, 3));
store.dispatch((0, _cartReducer.IncreasecartItem)(8));
store.dispatch((0, _wishlistReducer.IncreaseWishListItem)(3));
store.dispatch((0, _wishlistReducer.IncreaseWishListItem)(5));
store.dispatch((0, _wishlistReducer.DecreaseWishListItem)(5));
//store.dispatch({ type: CART_DELETE_ITEM, payload: { productId: 5} })
store.dispatch((0, _cartReducer.IncreasecartItem)(3));
store.dispatch((0, _cartReducer.IncreasecartItem)(2));
store.dispatch((0, _cartReducer.IncreasecartItem)(4));
// store.dispatch({ type: CART_ADD_QUANTITY, payload: { productId: 8,quantity:1} })
store.dispatch((0, _cartReducer.DecreasecartItem)(2)) //store.dispatch({ type: CART_DELETE_QUANTITY, payload: { productId: 1,quantity:1} })
;

},{"redux":"7RvxM","./cartReducer":"7K9qs","./wishlistReducer":"kP4lE","./productReducer":"9S9XY","@parcel/transformer-js/src/esmodule-helpers.js":"gsht0"}],"7RvxM":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gsht0"}],"gsht0":[function(require,module,exports,__globalThis) {
...
},{}],"7K9qs":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//Action createor
...
const CART_ADD_QUANTITY = 'cartItem/add/quantity';
const CART_DELETE_QUANTITY = 'cartItem/delete/quantity';
function IncreasecartItem(productId, quantity = 1) {
    return {
        type: CART_ADD_ITEM,
        payload: {
            productId,
...
function DecreasecartItem(productId, quantity = 1) {
    return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gsht0"}],"kP4lE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "IncreaseWishListItem", ()=>IncreaseWishListItem);
parcelHelpers.export(exports, "DecreaseWishListItem", ()=>DecreaseWishListItem);
...
function IncreaseWishListItem(productId, quantity = 1) {
    return {
        type: CART_WISHLIST_ADD,
        payload: {
            productId,
            quantity
        }
...
function DecreaseWishListItem(productId, quantity = 1) {
    return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gsht0"}],"9S9XY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./productList":"8X9rl","@parcel/transformer-js/src/esmodule-helpers.js":"gsht0"}],"8X9rl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const productList = [
    ...
    },
    {
        ...
        price: 22.3,
        description: "Slim-fitting style with contrast raglan long sleeves and a three-button Henley placket. Lightweight and breathable.",
        category: "men's clothing",
    ...
    },
    {
        ...
        price: 55.99,
        description: "Great outerwear jacket for spring, autumn, and winter. Suitable for hiking, camping, traveling, and outdoor use.",
        category: "men's clothing",
    ...
    },
    {
        ...
        price: 15.99,
        description: "Casual slim-fit shirt. Please review size information carefully before purchase.",
        category: "men's clothing",
    ...
    // -------- Jewelry --------
    {
        ...
        price: 695,
        description: "Inspired by the mythical water dragon. Wear inward for love and abundance, outward for protection.",
        category: "jewelery",
    ...
    // -------- Electronics --------
    {
        ...
        price: 64,
        description: "USB 3.0 compatible portable storage for fast data transfer and improved PC performance.",
    ...
    },
    {
        ...
        price: 109,
        description: "Boosts boot-up, shutdown, and application load speed with reliable SATA III performance.",
        category: "electronics",
    ...
    // -------- Women's Clothing --------
    {
        ...
        price: 56.99,
        description: "Detachable fleece liner, adjustable hood, and windproof design. Suitable for multiple seasons.",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gsht0"}]},["bWtwo","kTBnD"], "kTBnD", "parcelRequire94c2", {})

//# sourceMappingURL=redux training.3c14d121.js.map
