...
import cartReducer, { CART_ADD_ITEM, CART_ADD_QUANTITY, CART_DELETE_ITEM, CART_DELETE_QUANTITY, DecreasecartItem, IncreasecartItem } from "./cartReducer"
import wishList, { CART_WISHLIST_ADD, DecreaseWishListItem, IncreaseWishListItem, WISHLIST_REMOVE_ITEM } from "./wishlistReducer"
...
// store.dispatch(IncreasecartItem(1,5))
// store.dispatch(IncreasecartItem(2))
// store.dispatch(IncreasecartItem(5,3))
// store.dispatch(IncreasecartItem(8))

// store.dispatch(IncreaseWishListItem(3))
// store.dispatch(IncreaseWishListItem(5))
// store.dispatch(DecreaseWishListItem(5))

// //store.dispatch({ type: CART_DELETE_ITEM, payload: { productId: 5} })


// store.dispatch(IncreasecartItem(3))

//  store.dispatch(IncreasecartItem(2))
//  store.dispatch(IncreasecartItem(4))
// // store.dispatch({ type: CART_ADD_QUANTITY, payload: { productId: 8,quantity:1} })

// store.dispatch(DecreasecartItem(2))
